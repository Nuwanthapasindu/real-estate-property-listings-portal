...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/dashboard/createProperty.css">
</head>
<body>
...
<script src="<%= request.getContextPath() %>/assets/js/dashboard/createProperty.js"></script>
</body>
</html>