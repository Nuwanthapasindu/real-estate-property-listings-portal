...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/stylesPasswordReset.css">
</head>
<body>
<!-- Navigation -->
    ...
    <div class="row align-items-center min-vh-100">
        ...
        <div class="col-md-6">
            <div class="signup-form">
                ...
                <% } %>
                <form id="loginForm" method="post" action="reset-password">
        ...
        <div class="row align-items-center text-center text-md-start py-4">
            <div class="col-md-3 mb-4 mb-md-0">
                <a href="#" class="footer-brand d-inline-block">
                    <img src="../../assets/img/logo-white.png" alt="Homez" class="logo">
