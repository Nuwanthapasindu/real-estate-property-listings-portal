...
<jsp:include page="/components/navbar-light.jsp" />
    ...
    <main class="container">
        <div class="row align-items-center min-vh-100">
            <div class="col-md-6">
                <img src="<%= request.getContextPath()%>/assets/img/publicLoginImage.png" alt="Modern Architecture" class="img-fluid rounded">
            </div>
            <div class="col-md-6">
                <div class="signup-form">
                    ...
                    <div class="text-center mt-4">
                        <p>Don't have an account? <a href="<%= request.getContextPath()%>/auth/public/signup.jsp" class="text-primary">Signup</a></p>
                    </div>
                </div>
            </div>
        </div>
